...
|------------------|-------------------------|------------------------------------------------------|-----------------------------------|---------------------------|-----------------------------------------------------------------------------|------------------------------------------------------------------------|
| ESCS-04          | Desarrollador            | Requerimiento de diferenciación de perfiles de consumidores y proveedores | Módulo de perfil y datos personales | Tiempo de diseño          | El sistema debe gestionar las actualizaciones de perfil de consumidores y proveedores de manera independiente, sin interrumpir el acceso a la funcionalidad | Tiempo de implementación, horas hombre, costo total, número de artefactos modificados |
