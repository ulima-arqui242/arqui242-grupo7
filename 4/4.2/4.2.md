# 4.2. Mantenibilidad
| **Cod Escenario** | **Fuente del Estimulo** | **Estímulo**                    | **Artefacto** | **Artefacto**                  | **Entorno**                         | **Respuesta**                                                | **Medida de Respuesta**                             |
|------------------|-------------------------|----------------------------------------|-------------------------|--------------------------------|-------------------------------------|-------------------------------------------------------------|-----------------------------------------------------|
...
| 	ESCS-02 |Mantenibilidad |Requerimiento de actualización de algoritmos de seguridad	|Equipo de desarrollo y soporte|Sistema de autenticación	|Actualizaciones de seguridad	|El sistema debe permitir actualizaciones de seguridad sin interrumpir el servicio de autenticación	|El 100% de las actualizaciones se realizan con una interrupción menor a 5 minutos|
