...
|------------------|-------------------------|----------------------------------------|-------------------------|--------------------------------|-------------------------------------|-------------------------------------------------------------|-----------------------------------------------------|
| ESC-01           | Disponibilidad           | En un horario de alta demanda   | Alto número de consumidores utilizando la página en paralelo | Backend | En un horario de alta demanda y consumo | El backend no puede retonar datos como imágenes o videos de alta calidad | Tiempos que tarda en volver operativo los datos faltantes |
