...
| Código de Escenario | Estímulo | Fuente del Estímulo | Artefacto | Entorno | Respuesta | Medida de Respuesta |
|---------------------|----------|---------------------|-----------|---------|-----------|---------------------|
| ESC-01              | El plugin de geolocalización no logra identificar la dirección ingresada por el usuario | Plugin utilizado para obtener datos de geolocalización no responde | Módulo de Busqueda de servicios | Interacción habitual del usuario con el sistema | Reintentar conexión con el plugin de geolocalización | Implementar una función de respuesta que reintente la conexión con el plugin al este no responder a los 10 segundos  |
