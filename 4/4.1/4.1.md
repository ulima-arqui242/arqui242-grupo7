...
|---------------------|---------------------|----------|---------------------|-----------|---------|-----------|---------------------|
| ESC-01             | Disponibilidad      | El usuario intenta contactar a un proveedor. | Usuario o proveedor | Módulo de contacto y seguimiento de servicio | Uso normal de la aplicación con conexión a internet | El sistema asegura que la interfaz de contacto esté disponible y activa | 99.9% de tiempo activo para la funcionalidad de contacto; recuperación de servicio en menos de 2 segundos en caso de fallo |
| ESC-02             | Disponibilidad      | El usuario o el proveedor desea visualizar el estado del servicio. | Usuario o proveedor | Módulo de seguimiento de servicio | Aplicación móvil con conectividad intermitente o estable | El sistema asegura la sincronización de la información del estado del servicio en tiempo real | Actualización de la información del estado en menos de 1 segundo tras un cambio en la ubicación o estado del servicio |
| ESC-03             | Disponibilidad      | El servicio contratado está en curso. | Usuario o proveedor | Sistema de seguimiento en tiempo real | Condiciones normales de operación (conectividad adecuada) | El sistema de seguimiento mantiene actualizada la información y el estado del servicio sin interrupciones | El sistema debe registrar el estado del servicio con menos de 0.5% de pérdida de datos y latencia menor a 1 segundo en la actualización del estado |
| ESC-04             | Disponibilidad      | Fallo en la conectividad de red o del servidor. | Sistema o infraestructura de red | Módulo de seguimiento de servicio | Condiciones de red inestables o fallo en el servidor | El sistema debe garantizar la recuperación automática y rápida, con reintentos automáticos de conexión | Tiempo de recuperación del servicio no superior a 5 segundos después de la reconexión, con reintentos cada 3 segundos |
| ESC-05             | Disponibilidad      | El sistema necesita registrar los tiempos del servicio. | Aplicación o sistema | Módulo de contacto y seguimiento | Condiciones normales y en estado de servicio activo | El sistema debe recopilar y almacenar los tiempos de inicio, ejecución y finalización del servicio de manera confiable | Registro automático de los tiempos de cada estado del servicio con un margen de error no superior al 0.1% del tiempo real |
