...
1. **Balanceo de Carga con Replicación**
...
Se elige Balanceo de Carga con Replicación, ya que proporciona un buen equilibrio entre costo y rendimiento, asegurando que el sistema se mantenga disponible y pueda escalar con la demanda. Aunque la redundancia activa ofrece tiempos de recuperación más rápidos, sus costos elevados no son necesarios para el nivel de criticidad actual del sistema.
