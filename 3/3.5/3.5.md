...
En esta ocación se eligió next principalmente también por la familiariadad del equipo de desarrollo con el framwork, sin embargo cabe añadir que al ser NextJS un framork basado en React, cuenta con todas la mayoria de sus funcionalidades en adición a las propias.
